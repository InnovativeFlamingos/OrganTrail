...
namespace OrganTrail
{
    public partial class Hunting : Form
    {
        ...
        private void makeVirus()
        {
            ...
            PictureBox virus = new PictureBox(); // create a new picture box called zombie
            virus.Tag = "virus"; // add a tag to it called zombie
            //virus.Image = Properties.Resources.; // the default picture for the zombie is zbown
            virus.Left = rnd.Next(0, 900); // generate a number between 0 and 900 and assignment that to the new zombie left
            virus.Top = rnd.Next(0, 800); // generate a number between 0 and 800 and assignment that to the new zombie top
            virus.SizeMode = PictureBoxSizeMode.AutoSize; // set auto size for the new picture box
